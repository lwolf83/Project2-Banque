...
namespace JELListener
{
    class Database
    {
        ...
        {
            string sql = "UPDATE Transfert SET isDone = @isDone WHERE idTransfert = @idTransfert";

            SqlCommand cmd = new SqlCommand();
            cmd.Connection = Database.Instance._connection;
            cmd.CommandText = sql;
            cmd.Parameters.Add(new SqlParameter("@idTransfert", transfer.idTransfert));
            cmd.Parameters.Add(new SqlParameter("@isDone", transfer.isDone));
            cmd.ExecuteReader();
            cmd.Dispose();
        }
        ...
        public void UpdateAccount(Account account)
        {
            ...
            cmd.Connection = Database.Instance._connection;
            cmd.CommandText = sql;
            cmd.Parameters.Add(new SqlParameter("@amount", account.amount));
